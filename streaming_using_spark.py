...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars.packages",
                     "org.apache.spark:spark-sql-kafka-0-10_2.13:3.5.3")  # Spark-Kafka integration
             .config("spark.jars",
                     "/Users/airscholar/Dev/Projects/Python/Voting/postgresql-2.9.10.jar")  # PostgreSQL driver
